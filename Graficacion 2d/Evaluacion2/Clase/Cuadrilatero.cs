...
namespace Evaluacion2.Clase
{
    public class Cuadrilatero
    {
        ...
        private TextBox txtX1, txtX2, txtX3, txtX4, txtY1, txtY2, txtY3, txtY4, txtEnX, txtEnY, txtGrados;
        private PictureBox pictureBox;
        private double x1, x2, y1, y2, x4, y4;
        private int xcentro, ycentro;
        private double atan, atan1, atan2, atan3, b, b1, c, c1, d, d1, e, e1, an, an1, an2, an3, fx, fx1, fx2, fx3, fy, fy1, fy2,fy3, g, g1, g2,g3, j, j1, j2,j3, sqrt, sqrt1, sqrt2,sqrt3, z, z1, calc;
        public Cuadrilatero(TextBox txtX1, TextBox txtX2, TextBox txtX3, TextBox txtX4, TextBox txtY1, TextBox txtY2, TextBox txtY3, TextBox txtY4, TextBox txtEnX, TextBox txtEnY, TextBox txtGrados, PictureBox pictureBox)
        {
            this.txtX1 = txtX1;
            this.txtX2 = txtX2;
            this.txtX3 = txtX3;
        ...
        public void graficarCuadrilatero()
        {
            if (txtX1.Text == "")
            {
                txtX1.Focus();
        ...
        private void dibujarCuadrilatero()
        {
            ...
            vector.DrawLine(lapiz, Convert.ToInt32(x4), Convert.ToInt32(y4), Convert.ToInt32(x1), Convert.ToInt32(y1));

            lapiz.Dispose();
            vector.Dispose();
        }
        public void traslacionCuadrilatero()
        {
            int o, o1;
            vector = pictureBox.CreateGraphics();
            lapiz = new Pen(Color.Black);
